...
(
    ...
    assign vpn0 = dm_addr_i[`VPN0_UPPER:`VPN0_LOWER];
    assign vpn1 = dm_addr_i[`VPN1_UPPER:`VPN1_LOWER];
    assign vpo = dm_addr_i[`VPO_UPPER:`VPO_LOWER];
    assign vpn = dm_addr_i[`VPN_UPPER:`VPN_LOWER];
            ...
            case (state)
                ...
                ST_READ_PT_2_ACTION: begin
                    if (arb_ack_i) begin
                        ...
                        else if ((pte_u == 0 && request_privilege == `MODE_U) || (request_we == 0 && pte_r == 0) || (request_we == 1 && pte_w == 0)) begin
                            // page fault
                            dm_data_o <= 0;
                            dm_ack_o <= 1;
                            dm_err_o <= 1;
