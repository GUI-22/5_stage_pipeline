...
`define INSTR_XOR 17
`define INSTR_LW 18
`define INSTR_SLTU 19

// our custom instructions
`define INSTR_MIN 20
`define INSTR_SBSET 21
`define INSTR_ANDN 22

// csr instr
`define INSTR_CSRRW 23
`define INSTR_CSRRS 24
`define INSTR_CSRRC 25
`define INSTR_EBREAK 26
`define INSTR_ECALL 27
`define INSTR_MRET 28

// virtual memory related
`define PAGESIZE_LOG2 12
`define PTESIZE_LOG2 2
`define VPN0_UPPER 21
`define VPN0_LOWER 12
`define VPN1_UPPER 31
`define VPN1_LOWER 22
...
`define VPN_LOWER 12
`define VPN_WIDTH 20
`define PPN0_UPPER 19
`define PPN0_LOWER 10
`define PPN1_UPPER 31
`define PPN1_LOWER 20
`define PPN0_WIDTH 10
`define PPN1_WIDTH 12
`define PPN_UPPER 31
`define PPN_LOWER 10
`define PPN_WIDTH 22
...
`define MUX_MEM_CHOICE_ALU_RST 1
`define MUX_MEM_CHOICE_CSR_DATA 2
