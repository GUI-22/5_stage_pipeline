...
80000248:	72c000ef          	jal	ra,80000974 <WRITE_SERIAL>
    j .DONE
8000024c:	2d40006f          	j	80000520 <.DONE>
...
8000028c:	00c10113          	addi	sp,sp,12
    ...
    j .DONE
80000290:	2900006f          	j	80000520 <.DONE>
...
800002c8:	00810113          	addi	sp,sp,8
    j .DONE
800002cc:	2540006f          	j	80000520 <.DONE>
...
80000308:	00810113          	addi	sp,sp,8
    j .DONE
8000030c:	2140006f          	j	80000520 <.DONE>
...
80000350:	00810113          	addi	sp,sp,8
    j .DONE
80000354:	1cc0006f          	j	80000520 <.DONE>
...
80000384:	0042a383          	lw	t2,4(t0)
    li t3, 10000000
80000388:	00989e37          	lui	t3,0x989
8000038c:	680e0e13          	addi	t3,t3,1664 # 989680 <INITLOCATE-0x7f676980>
...
8000042c:	00c08093          	addi	ra,ra,12 # 80000434 <.USERRET_USER>
    // 进入用户程序
    mret
80000430:	30200073          	mret

80000434 <.USERRET_USER>:
    jr s10
#endif
...
.USERRET_USER:
    ebreak
80000434:	00100073          	ebreak

80000438 <USERRET_TIMEOUT>:
...
USERRET_TIMEOUT:
    ...
    // 告诉终端用户程序结束运行
    li a0, SIG_TIMEOUT
80000438:	08100513          	li	a0,129
    jal WRITE_SERIAL
8000043c:	538000ef          	jal	ra,80000974 <WRITE_SERIAL>
    j 0f
80000440:	00c0006f          	j	8000044c <USERRET_MACHINE+0x8>

80000444 <USERRET_MACHINE>:
...
0:
    la s1, uregs
8000044c:	007f0497          	auipc	s1,0x7f0
80000450:	bb448493          	addi	s1,s1,-1100 # 807f0000 <_sbss>
    li s2, TF_SIZE
80000454:	08000913          	li	s2,128
.LC4:
    lw a0, 0(sp)
80000458:	00012503          	lw	a0,0(sp)
    sw a0, 0(s1)
8000045c:	00a4a023          	sw	a0,0(s1)
    addi s2, s2, -4
80000460:	ffc90913          	addi	s2,s2,-4
    addi s1, s1, 0x4
80000464:	00448493          	addi	s1,s1,4
    addi sp, sp, 0x4
80000468:	00410113          	addi	sp,sp,4
    bne s2, zero, .LC4
8000046c:	fe0916e3          	bnez	s2,80000458 <USERRET_MACHINE+0x14>

    // 重新获得当前监控程序栈顶指针
    la s1, uregs
80000470:	007f0497          	auipc	s1,0x7f0
80000474:	b9048493          	addi	s1,s1,-1136 # 807f0000 <_sbss>
    LOAD sp, TF_ksp(s1)
80000478:	0804a103          	lw	sp,128(s1)

    j .DONE
8000047c:	0a40006f          	j	80000520 <.DONE>
...
.USERRET2:
    // 定位用户空间寄存器备份地址
    la ra, uregs
80000480:	007f0097          	auipc	ra,0x7f0
80000484:	b8008093          	addi	ra,ra,-1152 # 807f0000 <_sbss>

    // 不能先恢复 ra
    //STORE ra, TF_ra(ra)
    STORE sp, TF_sp(ra)
80000488:	0020a223          	sw	sp,4(ra)
    STORE gp, TF_gp(ra)
8000048c:	0030a423          	sw	gp,8(ra)
    STORE tp, TF_tp(ra)
80000490:	0040a623          	sw	tp,12(ra)
    STORE t0, TF_t0(ra)
80000494:	0050a823          	sw	t0,16(ra)
    STORE t1, TF_t1(ra)
80000498:	0060aa23          	sw	t1,20(ra)
    STORE t2, TF_t2(ra)
8000049c:	0070ac23          	sw	t2,24(ra)
    STORE s0, TF_s0(ra)
800004a0:	0080ae23          	sw	s0,28(ra)
    STORE s1, TF_s1(ra)
800004a4:	0290a023          	sw	s1,32(ra)
    STORE a0, TF_a0(ra)
800004a8:	02a0a223          	sw	a0,36(ra)
    STORE a1, TF_a1(ra)
800004ac:	02b0a423          	sw	a1,40(ra)
    STORE a2, TF_a2(ra)
800004b0:	02c0a623          	sw	a2,44(ra)
    STORE a3, TF_a3(ra)
800004b4:	02d0a823          	sw	a3,48(ra)
    STORE a4, TF_a4(ra)
800004b8:	02e0aa23          	sw	a4,52(ra)
    STORE a5, TF_a5(ra)
800004bc:	02f0ac23          	sw	a5,56(ra)
    STORE a6, TF_a6(ra)
800004c0:	0300ae23          	sw	a6,60(ra)
    STORE a7, TF_a7(ra)
800004c4:	0510a023          	sw	a7,64(ra)
    STORE s2, TF_s2(ra)
800004c8:	0520a223          	sw	s2,68(ra)
    STORE s3, TF_s3(ra)
800004cc:	0530a423          	sw	s3,72(ra)
    STORE s4, TF_s4(ra)
800004d0:	0540a623          	sw	s4,76(ra)
    STORE s5, TF_s5(ra)
800004d4:	0550a823          	sw	s5,80(ra)
    STORE s6, TF_s6(ra)
800004d8:	0560aa23          	sw	s6,84(ra)
    STORE s7, TF_s7(ra)
800004dc:	0570ac23          	sw	s7,88(ra)
    STORE s8, TF_s8(ra)
800004e0:	0580ae23          	sw	s8,92(ra)
    STORE s9, TF_s9(ra)
800004e4:	0790a023          	sw	s9,96(ra)
    STORE s10, TF_s10(ra)
800004e8:	07a0a223          	sw	s10,100(ra)
    STORE s11, TF_s11(ra)
800004ec:	07b0a423          	sw	s11,104(ra)
    STORE t3, TF_t3(ra)
800004f0:	07c0a623          	sw	t3,108(ra)
    STORE t4, TF_t4(ra)
800004f4:	07d0a823          	sw	t4,112(ra)
    STORE t5, TF_t5(ra)
800004f8:	07e0aa23          	sw	t5,116(ra)
    STORE t6, TF_t6(ra)
800004fc:	07f0ac23          	sw	t6,120(ra)

    // 重新获得当前监控程序栈顶指针
    LOAD sp, TF_ksp(ra)
80000500:	0800a103          	lw	sp,128(ra)
    mv a0, ra
80000504:	00008513          	mv	a0,ra
    la ra, .USERRET2
80000508:	00000097          	auipc	ra,0x0
8000050c:	f7808093          	addi	ra,ra,-136 # 80000480 <.USERRET2>
    STORE ra, TF_ra(a0)
80000510:	00152023          	sw	ra,0(a0)

    // 发送停止计时信号
    li a0, SIG_TIMETOKEN
80000514:	00700513          	li	a0,7
    // 告诉终端用户程序结束运行
    jal WRITE_SERIAL
80000518:	45c000ef          	jal	ra,80000974 <WRITE_SERIAL>

    j .DONE
8000051c:	0040006f          	j	80000520 <.DONE>
...
.DONE:
    // 交互循环
    j SHELL
80000520:	cf9ff06f          	j	80000218 <SHELL>
	...
...
.HANDLE_BREAK:
    j USERRET_MACHINE
800006e4:	d61ff06f          	j	80000444 <USERRET_MACHINE>
...
800006fc:	00029463          	bnez	t0,80000704 <CONTEXT_SWITCH>
    ...
    // 处理用户程序超时
    j USERRET_TIMEOUT
80000700:	d39ff06f          	j	80000438 <USERRET_TIMEOUT>
